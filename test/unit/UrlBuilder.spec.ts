...
describe("UrlBuilder", () => {
    ...
    it("builds abort", () => {
        expect(urlBuilder.buildAbort("https://test", "myTransport", "connection$token", "&a=b"))
            .toEqual("https://test/abort?clientProtocol=1.5&transport=myTransport&connectionToken=connection%24token&a=b");
    });
});